...
namespace Bed
{
    struct DirectionalLight
    {
        ...
        DirectionalLight(Bed::Colour3 lightColour, Bed::Vector3 lightDirection, float lightStrength) : Colour(lightColour), Direction(lightDirection), Strength(lightStrength) {}
