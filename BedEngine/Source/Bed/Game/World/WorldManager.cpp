...
Bed::WorldManager::~WorldManager()
{
    ecs.RemoveAllSystems();
}

bool Bed::WorldManager::LoadWorld(std::string path)
{
...
bool Bed::WorldManager::UnloadWorld()
{
    return false;
}

bool Bed::WorldManager::IsWorldLoaded()
{
    return false;
}

void Bed::WorldManager::BeginPlay()
{
