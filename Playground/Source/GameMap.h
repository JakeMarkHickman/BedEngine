...
namespace Game
{
    ...
    public:
        GameMap() {
            ...
            ecs.AttachComponents(ent1, Bed::Transform(Bed::Vector3(2.0f, 0.0f, -2.0f), Bed::Vector3(), Bed::Vector3(1.0f)),
                                       Bed::Velocity(Bed::Vector3(0.0f, 0.5f, 0.0f)),
                                       Bed::Render("Assets/Resources/Meshes/Tri.obj"));

            uint64_t ent2 = ecs.CreateEntity();
            ecs.AttachComponents(ent2, Bed::Transform(Bed::Vector3(-2.0f, 0.0f, -2.0f), Bed::Vector3(), Bed::Vector3(1.0f)),
                                       Bed::Velocity(Bed::Vector3(0.0f, -0.5f, 0.0f)),
