...
namespace Game
{
    ...
    public:
        GameMap() {
            ...
            ecs.AttachComponents(ent1, Bed::Transform(Bed::Vector3(0.0f, 0.0f, 0.0f), Bed::Vector3(0.0f, 0.0f, 0.0f), Bed::Vector3(0.0f, 0.0f, 0.0f)),
                                       Bed::Velocity(Bed::Vector3(0.0f, 0.5f, 0.0f))/*,
                                       Bed::TwoDimensionalRender(new Bed::Texture("Assets/Textures/TestBedEngineIcon.png"), 0)*/);
